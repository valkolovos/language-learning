...
from google.cloud import aiplatform, translate, texttospeech, speech
from google.cloud.aiplatform import MatchingEngine
        ...
        try:
            ...
            for result in response.results:
                transcriptions.append({
                    ...
                    ] if hasattr(result.alternatives[0], 'words') else []
                })
    ...
    async def generate_lesson_content(
        ...
        try:
            ...
            response = await asyncio.to_thread(
                ...
                messages=[
                    {"role": "system", "content": "You are an expert language teacher specializing in creating engaging, research-based language learning content."},
    ...
    async def generate_exercises(
        ...
        try:
            ...
            response = await asyncio.to_thread(
                ...
                model=settings.AI_MODEL_NAME,
                messages=[
                    {"role": "system", "content": "You are an expert language teacher creating engaging exercises for language learning."},
                    {"role": "user", "content": prompt}
                ],
                temperature=0.8,
                max_tokens=1500
